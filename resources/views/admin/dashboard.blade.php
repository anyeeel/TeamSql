        ...
        <tbody>
                ...
                @foreach($items as $item)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-no-wrap text-right text-sm leading-5 font-medium">
                            <!-- Edit Icon -->
                            <a href="{{ route('items.edit', $item->id) }}" class="text-indigo-600 hover:text-indigo-900" title="Edit">
                                <i class="fas fa-edit"></i>
                            </a>

                            <!-- Delete Icon with confirmation dialog -->
                            <button onclick="deleteItem({{ $item->id }})" class="text-red-600 hover:text-red-900 ml-2" title="Delete">
            ...
            <tr>
                ...
                <td class="px-6 py-4 whitespace-no-wrap text-right text-sm leading-5 font-medium">
                    ...
                    <button onclick="deleteItem(0)" class="text-red-600 hover:text-red-900 ml-2" title="Delete">
                        <i class="fas fa-trash-alt"></i>
                    </button>
                </td>
            </tr>
